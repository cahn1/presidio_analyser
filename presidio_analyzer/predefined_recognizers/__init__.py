...
from .crypto_ethereum_recognizer import CryptoEthereumRecognizer
...
from .us_taxid_recognizer import UsTaxIDRecognizer
from .kr_ssn_recognizer import KrSsnRecognizer
